...
int main(int argc, char **argv) {
  ...
  CmdVel_pub[0] = NodeHandle->advertise<geometry_msgs::Twist>("/cmd_velA", 1);
  CmdVel_pub[1] = NodeHandle->advertise<geometry_msgs::Twist>("/cmd_velB", 1);
  CmdVel_pub[2] = NodeHandle->advertise<geometry_msgs::Twist>("/cmd_velC", 1);
  CmdVel_pub[3] = NodeHandle->advertise<geometry_msgs::Twist>("/cmd_velD", 1);
  ...
  while(1) {
    ...
    switch(r) {
      ...
      if(data->product_id == PRODUCT_A && data->vendor_id == VENDOR_A) {
        ...
        if(buffer[6] == 2){
          //cout << "** SHOOT - R1 **"<< endl;
          CmdVel[0].angular.z = 1;
        }

        if(buffer[6] == 8){
          //cout << "** TURBO - R2 **"<< endl;
          CmdVel[0].angular.z = 2;
        }

        if(buffer[6] == 1){
          //cout << "** L1 **"<< endl;
          CmdVel[0].angular.z = 1.5;
        }
      }
  ...
  while(1) {
    ...
    switch(r) {
      ...
      if(data->product_id == PRODUCT_A && data->vendor_id == VENDOR_A) {
        ...
        if(buffer[6] == 2){
          //cout << "** SHOOT - R1 **"<< endl;
          CmdVel[1].angular.z = 1;
        }

        if(buffer[6] == 8){
          //cout << "** TURBO - R2 **"<< endl;
          CmdVel[1].angular.z = 2;
        }

        if(buffer[6] == 1){
          //cout << "** L1 **"<< endl;
          CmdVel[1].angular.z = 1.5;
        }
      }
      else if(data->product_id == PRODUCT_B && data->vendor_id == VENDOR_B) {
        if((buffer[1] >= 0) && (buffer[1] < 127)){
  ...
  while(1) {
    ...
    switch(r) {
      ...
      if(data->product_id == PRODUCT_A && data->vendor_id == VENDOR_A) {
        ...
        if(buffer[6] == 2){
          //cout << "** SHOOT - R1 **"<< endl;
          CmdVel[2].angular.z = 1;
        }

        if(buffer[6] == 8){
          //cout << "** TURBO - R2 **"<< endl;
          CmdVel[2].angular.z = 2;
        }

        if(buffer[6] == 1){
          //cout << "** L1 **"<< endl;
          CmdVel[2].angular.z = 1.5;
        }
      }
      else if(data->product_id == PRODUCT_B && data->vendor_id == VENDOR_B) {
        if((buffer[1] >= 0) && (buffer[1] < 127)){
  ...
  while(1) {
    ...
    switch(r) {
      ...
      if(data->product_id == PRODUCT_A && data->vendor_id == VENDOR_A) {
        ...
        if(buffer[6] == 2){
          //cout << "** SHOOT - R1 **"<< endl;
          CmdVel[3].angular.z = 1;
        }

        if(buffer[6] == 8){
          //cout << "** TURBO - R2 **"<< endl;
          CmdVel[3].angular.z = 2;
        }

        if(buffer[6] == 1){
          //cout << "** L1 **"<< endl;
          CmdVel[3].angular.z = 1.5;
        }
      }
      else if(data->product_id == PRODUCT_B && data->vendor_id == VENDOR_B) {
        if((buffer[1] >= 0) && (buffer[1] < 127)){
