...
bool setupStart = false, gameStart = false, paused = false, teamGame = false, aiGame = false;
int  game = -1, state = -1, pitank_gamestate = -1, robotf_gamestate = -1, raceCar_gamestate = -1;
QTime game_clock;
