...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       teamId,tagId,x,y,height,angle,addr0,addr1,vel1,vel2,previous_vel,collisionFlag,threadIsRunning,collisionStateVar,autonomous_drive,immobilized,damage,kills
