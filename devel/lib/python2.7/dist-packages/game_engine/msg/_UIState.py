...
class UIState(genpy.Message):
  _md5sum = "3e166d509eed64c7b231607645e715e9"
...
int32 seconds
"""
  __slots__ = ['setupStart','gameStart','teamGame','paused','aiGame','seconds']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       setupStart,gameStart,teamGame,paused,aiGame,seconds
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_5Bi().pack(_x.setupStart, _x.gameStart, _x.teamGame, _x.paused, _x.aiGame, _x.seconds))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.setupStart, _x.gameStart, _x.teamGame, _x.paused, _x.aiGame, _x.seconds,) = _get_struct_5Bi().unpack(str[start:end])
